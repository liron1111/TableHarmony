  ...
  if (membership.role === "manager") {
    navItems.push(
      ...[
        {
          name: "Docs",
          href: schoolPath("/docs"),
          icon: <BookIcon className="size-5" />,
          active: isNavItemActive("/docs"),
          position: "bottom",
        },
        {
          name: "Analytics",
          ...
          active: isNavItemActive(`/${schoolId}/analytics`),
          position: "bottom",
        },
        {
          name: "Enrollments",
          ...
          active: isNavItemActive(`/${schoolId}/enrollments`),
          position: "bottom",
        },
        {
          name: "Memberships",
          ...
          active: isNavItemActive(`/${schoolId}/memberships`),
          position: "bottom",
        },
        {
          name: "Settings",
